...
* [8. Setup Remote Attestation on Host and TD Guest](#setup-remote-attestation)
...
This early preview of TDX on Ubuntu 23.10 provides base host, guest, and remote attestation functionalities. 
Follow these instructions to setup and use it.  
...
This release supports 4th Generation Intel® Xeon® Scalable Processors with Intel® TDX and all 5th Generation Intel®  Xeon® Scalable Processors.  For remote attestation, production-grade hardware is required.

<a id="setup-tdx-host"></a>
## 4. Setup TDX Host
In this section, you will install a generic Ubuntu 23.10 server, install necessary packages to turn 
...
the data has been sent to cache server successfully and retrieval_result.csv has been generated successfully!
```

An example output of failed registration:
...
[../tdx_attest.c:537] Inappropriate ioctl for device
...
4. Finally, attest with the Intel Trust Authority service using the [`trustauthority-cli`](https://github.com/intel/trustauthority-client-for-go/tree/main/tdx-cli) tool.  
